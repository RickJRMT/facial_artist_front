...
export const obtenerHojasVidaCliente = async (idCliente) => {
    try {
        const response = await axios.get(`${API_URL_HOJAS_VIDA}/completa/cliente/${idCliente}`);
...
export const obtenerTodasHojasVida = async () => {
    try {
        const response = await axios.get(`${API_URL_HOJAS_VIDA}/completa/todas`);
        return response.data.success ? response.data.data : [];
    } catch (error) {
...
export const obtenerHojaVidaPorId = async (idHv) => {
    try {
        const response = await axios.get(`${API_URL_HOJAS_VIDA}/completa/hv/${idHv}`);
...
export const crearHojaVida = async (hojaVidaData) => {
    try {
        const response = await axios.post(API_URL_HOJAS_VIDA, hojaVidaData);
        return response.data.success ? response.data.data : null;
    } catch (error) {
...
export const actualizarHojaVida = async (idHv, hojaVidaData) => {
    try {
        const response = await axios.put(`${API_URL_HOJAS_VIDA}/${idHv}`, hojaVidaData);
        return response.data.success ? response.data.data : null;
    } catch (error) {
...
export const eliminarHojaVida = async (idHv) => {
    try {
        const response = await axios.delete(`${API_URL_HOJAS_VIDA}/${idHv}`);

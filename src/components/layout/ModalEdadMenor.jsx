...
const ModalErrorEdadMenor = ({ onClose }) => {
  return (
  ...
  <div className="modal-edad-contenido">
    ...
    <p className="modal-edad-texto">Lo siento, debes tener al menos 13 años para solicitar este servicio.</p>
...
export default ModalErrorEdadMenor;